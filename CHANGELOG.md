...
- [`bcc6ef1`](https://github.com/lukehsiao/zola-pickles/commit/bcc6ef168daf8a9bd14eb1c5b9f9a6e684524acc) - **refactor**: site search is now [Pagefind](https://pagefind.app/) behind `extra.search_enable`, replacing the elasticlunr dialog that `build_search_index` used to switch on.
...
<pre>
$ git-stats v0.4.1..v0.4.2
Author      Commits  Changed Files  Insertions  Deletions  Net Δ
Luke Hsiao        1             13        +171       -821   -650
Total             1             13        +171       -821   -650
</pre>
...
- [`e725a69`](https://github.com/lukehsiao/zola-pickles/commit/e725a6968c4dbd841af9ed2296d492cc1f61fb11) - **feat**: the theme now renders a search dialog when `build_search_index = true`.
...
<pre>
$ git-stats v0.4.0..v0.4.1
Author           Commits  Changed Files  Insertions  Deletions  Net Δ
dependabot[bot]        4              5         +31        -31      0
Luke Hsiao             2             16       +1120       -762   +358
Total                  6             21       +1151       -793   +358
</pre>
...
- [`844d61e`](https://github.com/lukehsiao/zola-pickles/commit/844d61e2fe5a32c892183269a2d0000662667ae8) - **Breaking**: the theme now requires Zola 0.23. That release removed shortcodes and moved to Tera 2, and neither change is backwards compatible.
...
<pre>
$ git-stats v0.3.6..v0.4.0
Author           Commits  Changed Files  Insertions  Deletions  Net Δ
Luke Hsiao             1             17        +112        -82    +30
dependabot[bot]        1              1          +1         -1      0
Total                  2             18        +113        -83    +30
</pre>
